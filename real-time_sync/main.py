...
def helper_get_resource_type_from_extension(extension):
    ...
    image_extentions = ["ai", "gif", "webp", "bmp", "djvu", "ps", "ept", "eps", "eps3", "flif", "gif", "heif", "heic", "ico", "jpg",
                          "jpe", "jpeg", "jp2", "wdp", "jxr", "hdp", "pdf", "png", "psb", "psd", "arw", "cr2", "svg", "tga", "tif", "tiff", "webp"]
